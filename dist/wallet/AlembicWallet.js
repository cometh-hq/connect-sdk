...
class AlembicWallet {
    constructor({ authAdapter, apiKey }) {
        ...
        this._signTransactionWithEOA = (safeTxData) => __awaiter(this, void 0, void 0, function* () {
            ...
            return yield signer._signTypedData({
                ...
                nonce: ethers_1.BigNumber.from(yield SafeUtils_1.default.getNonce(this.getAddress(), this.getOwnerProvider())).toString()
            });
        });
    ...
    signTransaction(safeTxData) {
        return __awaiter(this, void 0, void 0, function* () {
            if (yield this._verifyWebAuthnOwner()) {
                return yield this._signTransactionwithWebAuthn(safeTxData);
            }
            else {
                return yield this._signTransactionWithEOA(safeTxData);
            }
        });
    }
    ...
    sendTransaction(safeTxData) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            const nonce = yield SafeUtils_1.default.getNonce(this.getAddress(), this.getOwnerProvider());
    ...
    addWebAuthnOwner() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!signer)
                throw new Error('No signer found');
            const webAuthnCredentials = yield WebAuthnUtils_1.default.createCredentials(this.getAddress());
            ...
            const predictedSignerAddress = yield WebAuthnUtils_1.default.predictSignerAddress(publicKey_X, publicKey_Y, this.chainId);
            ...
            yield WebAuthnUtils_1.default.waitWebAuthnSignerDeployment(publicKey_X, publicKey_Y, this.chainId, this.getOwnerProvider());
    ...
    _signTransactionwithWebAuthn(safeTxDataTyped) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const safeTxHash = yield SafeUtils_1.default.getSafeTransactionHash(this.getAddress(), safeTxDataTyped, this.chainId);
            const encodedWebAuthnSignature = yield WebAuthnUtils_1.default.getWebAuthnSignature(safeTxHash, currentWebAuthnOwner.publicKey_Id);
    ...
    _signMessageWithWebAuthn(messageToSign) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!currentWebAuthnOwner)
                throw new Error('No WebAuthn signer found');
            const encodedWebAuthnSignature = yield WebAuthnUtils_1.default.getWebAuthnSignature(ethers_1.ethers.utils.keccak256(messageToSign), currentWebAuthnOwner.publicKey_Id);
            return SafeUtils_1.default.formatWebAuthnSignatureForSafe(currentWebAuthnOwner.signerAddress, encodedWebAuthnSignature);
        });
    }
}
