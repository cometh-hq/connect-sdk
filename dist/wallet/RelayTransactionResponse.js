    ...
    wait() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            while (!txSuccessEvent && !txFailureEvent) {
                ...
                txSuccessEvent = yield SafeUtils_1.default.getSuccessExecTransactionEvent(this.safeTxHash, this.from, this.provider);
                txFailureEvent = yield SafeUtils_1.default.getFailedExecTransactionEvent(this.safeTxHash, this.from, this.provider);
            }
            if (txSuccessEvent) {
                let txResponse = null;
