...
export interface SimulateTxAcessorInterface extends utils.Interface {
  functions: {
...
export interface SimulateTxAcessor extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SimulateTxAcessorInterface;
